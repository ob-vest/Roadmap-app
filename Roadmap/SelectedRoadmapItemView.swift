            ...
            VStack(alignment: .leading, spacing: 10) {
                ...
                VStack(alignment: .leading) {
                    ...
                    Text(request.typeString)
                        .font(.caption)
                        .bold()
                        .foregroundStyle(request.type?.color ?? .secondary)
                        .padding(.horizontal, 10)
                        .padding(.vertical, 5)
                        .background((request.type?.color ?? .secondary).opacity(0.2)
                            .overlay( RoundedRectangle(cornerRadius: 10).stroke(request.type?.color ?? .secondary, lineWidth: 1)))
                        .cornerRadius(10)
                }
